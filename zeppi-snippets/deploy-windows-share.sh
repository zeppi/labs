#!/bin/bash
## Usage: deploy-windows-share.sh [options]
##
## Deploy using in windows share
##
## Options:
...
sudo mount -t cifs //<ip server>/<folder> /mnt/share \
 -o username=<username>,rw,nounix,iocharset=utf8,file_mode=0777,dir_mode=0777,uid=<...>,gid=<...>
